...
class InstallIntegrit:
    def __init__(self):
        ...
        self.ethernet_mac = data.get('Ethernet Mac',None)
        self.wifi_mac = data.get('WIFI Mac', None)
        self.bt_mac = data.get('BT Mac', None)
        self.name = data.get('MODEL', None)
        self.version = data.get('HW', None)
    ...
    def send_airpath(self, user_id):
        ...
        datas = {"SN": self.sn,
                 "SOM S/N": self.som_sn,
                 "Ethernet Mac": self.ethernet_mac,
