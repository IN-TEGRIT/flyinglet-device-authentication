...
# 로그 파일 경로 설정
log_file_path = './flyinglet-device-authentication-v1.2.0.log'
...
if '__main__' == __name__:
    ...
    parser.add_argument('--version', action='version', version='v 1.3.0', help='Show the version of the script')
